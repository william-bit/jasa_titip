      ...
      <div className="w-full ">
        <form className="px-5 py-3" onSubmit={handleSubmit(onSubmit)}>
          <TextInput
            ...
            name="name"
            type="text"
            placeholder="Product for Listing"
            register={register}
          ></TextInput>
          ...
          <TextInput
            ...
            register={register}
          ></TextInput>
          {formError.errors?.price?.map((item: string, i: number) => (
            <div key={i} className="text-sm text-center text-red-600">
              {item}
            </div>
          ))}
          {/* <TextInput
            ...
            register={register}
          ></TextInput>
          {formError.errors?.location?.map((item: string, i: number) => (
            <div key={i} className="text-sm text-center text-red-600">
              {item}
            </div>
          ))} */}
          <TextInput
            ...
            register={register}
          ></TextInput>
          {formError.errors?.description?.map((item: string, i: number) => (
            <div key={i} className="text-sm text-center text-red-600">
              {item}
            </div>
          ))}
